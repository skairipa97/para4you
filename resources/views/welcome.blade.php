...
<style>
    header{
        ...
        background:linear-gradient(rgba(128, 128, 128, 0.5), rgba(113, 106, 106, 0.5)), url('img\\bann.jpeg'); /* Replace 'your-image-url.jpg' with the actual URL or path of your image */
    ...
    .btn:hover{
        background-color:#c98eb6 !important;
